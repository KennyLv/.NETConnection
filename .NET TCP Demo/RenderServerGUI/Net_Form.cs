...
namespace RenderServerGUI
{
    public partial class Net_Form : Form
    {
        ...
        private List<RenbarLib.Environment.RenbarServer> MyServerList = new List<RenbarLib.Environment.RenbarServer>();

        private string ServerXMLPath = string.Empty;
        /***********************************************************************************************/
        ...
        public Net_Form()
        {
            ...
            this.ServerXMLPath = RenderServerGUI.Properties.Settings.Default.Path;
        ...
        {
            ConnectOkMsg = "Connect is Success";
            ConnectErrMsg = "Connect is Fail";
            switch (resultVar)
            {
        ...
        {
            if (this.EnvSvr.DeleteServer(ServerXMLPath, comboBox_Server.Text.Trim()))
            {
